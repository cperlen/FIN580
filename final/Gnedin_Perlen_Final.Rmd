...
plot_hmm_train=function(curr_i,n_states){
  ...
  pdf(paste(currencies[curr_i],"_TR_daily.pdf",sep=""), onefile=T, paper='A4r')
  plot(data$Date,post_probs$state, type='s', main='True Regimes - Daily', xlab='', ylab='Regime')
  dev.off()
   pdf(paste(currencies[curr_i],"_TR_pp_daily.pdf",sep=""), onefile=T, paper='A4r')
  ...
  pdf(paste(currencies[curr_i],"_TR_weekly.pdf",sep=""), onefile=T, paper='A4r')
  plot(data$Date,post_probs$state, type='s', main='True Regimes - Weekly', xlab='', ylab='Regime')
  dev.off()
   pdf(paste(currencies[curr_i],"_TR_pp_weekly.pdf",sep=""), onefile=T, paper='A4r')
