...
plot_hmm_train=function(i,n_states){
  ...
  daily_states[length(daily_states)+1]=data.frame(post_probs$state)
  ...
  hmm_fit=fit(hmm,verbose=FALSE)
  post_probs=posterior(hmm_fit)
  weekly_states[length(weekly_states)+1]=data.frame(post_probs$state)
...
setwd("~/Documents/Grad_School/2016-2017_Spring/Amin/Homework/HW_3/FIN580/final/data")
save(daily_states,file="Daily_states_train.RData")
save(weekly_states,file="Weekly_states_train.RData")
