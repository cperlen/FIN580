...
barplot(colMeans(mses_var_lasso_det_2),pch=1,col=1:9,main="Average MSE by currency for 1-lag VAR lasso",ylab="Ave MSE by currency",names.arg=names,cex.names=0.8)
